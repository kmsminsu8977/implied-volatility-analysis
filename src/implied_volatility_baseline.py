...
PROJECT = {"analysis_type": "implied_volatility", "category": "Derivatives Pricing & Volatility", "columns": ["quote_id", "spot", "strike", "rate", "maturity", "option_type", "market_price"], "methods": ["관측 가격을 입력으로 두고 이분법으로 Black-Scholes 내재변동성을 찾는다.", "moneyness 구간별로 변동성 차이를 비교해 smile/skew의 직관을 정리한다.", "가격 데이터는 행사가별 smile 구조를 드러내도록 구성한 학습용 quote다."], "module_name": "implied_volatility_baseline", "objective": "시장 옵션가격에서 Black-Scholes 내재변동성을 역산하고 smile 구조를 해석한다.", "question": "같은 만기에서 행사가별 시장가격은 어떤 변동성 구조를 암시하는가?", "rows": [["CALL_90", 100, 90, 0.03, 0.5, "call", 12.85], ["CALL_100", 100, 100, 0.03, 0.5, "call", 6.35], ["CALL_110", 100, 110, 0.03, 0.5, "call", 2.85], ["PUT_95", 100, 95, 0.03, 0.5, "put", 3.35], ["PUT_105", 100, 105, 0.03, 0.5, "put", 7.25]], "sample_name": "market_option_quotes.csv", "title_en": "Implied Volatility Analysis", "title_ko": "내재변동성 분석"}
